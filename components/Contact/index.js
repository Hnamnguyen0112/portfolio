...
export default function Contact() {
      ...
      .then(
        ...
        () => {
          ...
          setDialogContent({
            ...
            message:
              'I am performing scheduled maintenance, and really sorry for this inconvenience.',
            close: 'Close',
          });
          setDialog(true);
        }
  ...
  return (
    <div className="max-w-6xl mx-auto mb-12 animate-fade-in-up">
      ...
      >
        <div className="flex">
          <h1 className="font-bold uppercase text-4xl text-black">
            Send me a message
          </h1>
        </div>
        ...
        <div className="my-4">
          <textarea
            placeholder="Message*"
            className={
              'w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline ' +
      ...
      <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-white rounded-2xl border">
        <div className="flex flex-col text-black">
          <h1 className="font-bold uppercase text-4xl my-4 text-black">
            Work with me
          </h1>
          <p>
