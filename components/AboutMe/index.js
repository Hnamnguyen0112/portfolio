...
export default function AboutMe() {
  return (
    <div id="about-me" className='animate-fade-in-down md:my-20 mx-auto max-w-6xl min-w-0 py-10 md:py-4 px-4 rounded shadow-lg bg-white flex flex-col md:flex-row relative'>
      <div className="basis-1/3 mx-auto">
        <Image priority src={'/avatar.png'} alt="avatar" className="rounded-3xl" width={400} height={400} />
      </div>
