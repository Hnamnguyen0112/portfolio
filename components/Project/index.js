    ...
    <div className="max-w-5xl mx-auto">
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
        {props.project && props.project.map((item, key) =>
          <div key={key} className={'w-full border-2 p-6 rounded-lg shadow-lg ' + (mode ? 'bg-black border-white' : 'border-amber-300')}>
            <div id="header" className="flex items-center mb-4">
              <div className={'w-20 rounded-full border-2 ' + (mode ? 'border-gray-300 ' : 'border-amber-900')}>
