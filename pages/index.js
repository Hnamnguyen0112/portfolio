...
export default function Home() {
  ...
  return (
    <div className={'px-5 pt-40 pb-5 ' + (mode ? 'bg-black text-white' : 'bg-amber-50 text-amber-900')}>
      <Head>
                  ...
                  className={({ selected }) =>
                    classNames(
                      ...
                      selected
                        ...
                        : (mode ? 'text-white hover:bg-white hover:text-black' : 'text-amber-900 hover:bg-amber-200 hover:text-white'),
                    )
                  }
                >
                  {category}
