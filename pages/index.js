...
export default function Home() {
  ...
  return (
    <div className='max-w-screen min-h-screen px-5 pt-40 bg-[#072740] text-white'>
      <Head>
      ...
      <div className={devtoolStatus ? 'hidden' : 'block'}>
        ...
        {/*{mode &&*/}
        {/*  <div className={'lg:px-16 py-8 sm:py-16 flex flex-col items-center lg:flex-row lg:items-start lg:justify-center gap-x-6 xl:gap-x-20'}>*/}
        {/*    <FirstBlock/>*/}
        {/*    <SecondBlock/>*/}
        {/*    <ThirdBlock/>*/}
        {/*  </div>*/}
